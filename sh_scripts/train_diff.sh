...
DATA_DIR="--data_dir datasets/shtech_A/joint_learn/shtech_A/part_1/train --val_samples_dir datasets/classifier/shtech_A/test"
LOG_DIR="--log_dir experiments/dummy" 
#--resume_checkpoint experiments/joint_learn-shha-3/model090000.pt"
...
python scripts/super_res_train.py $DATA_DIR $LOG_DIR $TRAIN_FLAGS $MODEL_FLAGS